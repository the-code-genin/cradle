...
class ViewCompiler
{
	// Stores the view object in the order that they will be compiled
	private $views = [];
	...
	/**
	 * Compiles a view object and gets the output.
	 */
	private function compileView(View $view): ?string
	{
		// Check if the file to be included exists
