...
// Autoloader function for cradle core framework and application components
spl_autoload_register(function ($class) {
	// Confirm a that a cradle core framework or application component is to be loaded
	$classPath = explode('\\', $class);
	if ($classPath[0] != 'Cradle' |
		!in_array($classPath[1], ['Application', 'Framework']) |
		($classPath[1] == 'Application' & !in_array($classPath[2], ['Controllers', 'Config', 'Models']))) {
		return;
	}
